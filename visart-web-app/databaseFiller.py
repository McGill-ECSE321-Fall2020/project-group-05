...
import sys
import random
url = "https://vis-art-application-production.herokuapp.com/" # development server
...
try:
    ...
    print(ppost("artlisting/update_post_images/{idCode}".format(idCode=listing1),data={
        'images':['https://firebasestorage.googleapis.com/v0/b/visartapplication.appspot.com/o/postedImages%2Fcbedc80e-14cf-4f44-a439-4668af293158.png?alt=media&token=572fc96b-6b81-46a0-b181-6679f739adce']
        }))
