...
public class Tag {
  ...
  public Tag(TagType aType, String aKeyword, String aIdCode, ArtListing aListing) {
    ...
    if (!didAddListing) {
      throw new RuntimeException(
          "Unable to create tag due to listing. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
  ...
  public String toString() {
    return super.toString() + "[" +
        ...
        "  " + "type" + "="
        + (getType() != null
            ? !getType().equals(this) ? getType().toString().replaceAll("  ", "    ") : "this"
            : "null")
        + System.getProperties().getProperty("line.separator") +
        "  " + "listing = "
        + (getListing() != null ? Integer.toHexString(System.identityHashCode(getListing()))
            : "null");
  }
}