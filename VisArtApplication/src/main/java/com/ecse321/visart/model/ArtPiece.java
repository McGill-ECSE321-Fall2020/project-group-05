...
public class ArtPiece {
  ...
  public ArtPiece(PieceLocation aBasicLocation, String aAddressLocation, String aIdCode,
    ...
    if (!didAddArtListing) {
      throw new RuntimeException(
          "Unable to create piece due to artListing. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
  ...
  public String toString() {
    return super.toString() + "[" +
        ...
        "  " + "basicLocation" + "="
        + (getBasicLocation() != null ? !getBasicLocation().equals(this)
            ? getBasicLocation().toString().replaceAll("  ", "    ")
            : "this" : "null")
        + System.getProperties().getProperty("line.separator") +
        "  " + "artListing = "
        + (getArtListing() != null ? Integer.toHexString(System.identityHashCode(getArtListing()))
            : "null")
        + System.getProperties().getProperty("line.separator") +
        "  " + "artOrder = "
        + (getArtOrder() != null ? Integer.toHexString(System.identityHashCode(getArtOrder()))
            : "null");
  }
}