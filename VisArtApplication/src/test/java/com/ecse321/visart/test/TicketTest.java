...
public class TicketTest {
  ...
  void ticketCreateTest() {
    ...
    ArtPiece anArtPiece = new ArtPiece(ArtPiece.PieceLocation.Offsite, "UniversityStreet", id + 4,
        aListing);
    ArtOrder anArtOrder = new ArtOrder(false, ArtPiece.PieceLocation.Offsite, "SherbrookeStreet",
        "00Tracker", id + 5, anArtPiece, false, 100.00, "id123", aCustomer, anArtist);
    ...
    Ticket testTicket = ticketRepo.createTicket(isAPaymentConfirmed, aPaymentAmount, "" + l,
        isDeliveredForOrder, ArtPiece.PieceLocation.Offsite, aTargetAddressForOrder,
        aDeliveryTrackerForOrder, aIdCodeForOrder, anArtPiece, aCustomer, anArtist);
