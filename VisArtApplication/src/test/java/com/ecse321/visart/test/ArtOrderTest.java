...
public class ArtOrderTest {
	...
	void init() {
		...
		artist2 = aRepo.createArtist("testa" + l + 1, "steves@gmail.com", "Steves Jobs", "steves56", "apples1234");
		artListing2 = alRepo.createArtListing(ArtListing.PostVisibility.Public, "t" + l + 77, artist2);

		artPiece = apRepo.createArtPiece(PieceLocation.AtGallery, "676Alston", "AAA" + l + 2, artListing2);
		artPiece3 = apRepo.createArtPiece(PieceLocation.AtGallery, "699Alston", "AAA" + l + 45, artListing2);

		artPiece2 = apRepo.createArtPiece(PieceLocation.Offsite, "346STLOUIS", "ttt" + l + 3, artListing);
		customer = cRepo.createCustomer("tests" + l + 4, "KPP@GMAIL.COM", "KYARY", "KPP123", "japan56");
	...
	void createArtOrder1() {
		artOrder2 = aoRepo.createArtOrder(false, ArtPiece.PieceLocation.Offsite, address2, tracker2, "tts" + l + 9,
				artPiece2);
