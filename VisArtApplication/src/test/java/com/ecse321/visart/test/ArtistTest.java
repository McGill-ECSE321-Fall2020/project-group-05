...
public class ArtistTest {
  ...
  void init1() {
    id = l + "test_artist";
    customer = cRepo.createCustomer(id, "test@email", "displayname01", "myUsername", "what",
        "link.com", "hi i am");
  }
  ...
  void testCreate1() {
    ...
    assertEquals(customer.getUser().getDisplayname(),
        artist.getCustomer().getUser().getDisplayname());
  }
